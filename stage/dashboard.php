...
<div class="container-lg undisplayed" id="main_container">
            ...
            <ul class="nav nav-pills" id="memo_tab" role="tablist">
                <li class="nav-item dropdown header-nav">
                    <div class="link-symbol-wrapper">
                        <a class="nav-link link-symbol" onclick="app.changeViewType(this)" role="button"
                           title="Desktop view" href="javascript:void(0)"
                           aria-expanded="false" id="header_desktop"><span>&#x1f4bb;</span></a>
                        <a class="nav-link link-symbol" onclick="app.changeViewType(this)" role="button"
                           title="Mobile view" href="javascript:void(0)"
                           aria-expanded="false" id="header_mobile"><span>&#128241;</span></a>
                    </div>
                </li>
                <li class="nav-item header-menu" role="presentation">
                    <button class="nav-link active" id="pills_servers_tab" data-bs-toggle="pill"
                            data-bs-target="#pills_servers" type="button" role="tab"
                            aria-controls="pills_servers" aria-selected="true">
                        <span class="nav-button">SERVERS</span>
                    </button>
                </li>
                <li class="nav-item header-menu" role="presentation">
                    <button class="nav-link " id="pills_keys_tab" data-bs-toggle="pill"
                            data-bs-target="#pills_keys" type="button" role="tab"
                            aria-controls="pills_keys" aria-selected="false">
                ...
                <li class="nav-item header-menu" role="presentation">
                    <button class="nav-link " id="pills_server_tab" data-bs-toggle="pill"
                        ...
                        <span class="nav-button">PROPS</span>
                    </button>
                </li>
            </ul>
        </div>
        <div class="row header-keys-nav undisplayed" id="header_keys_nav">
            <div class="row header-keys-buttons">
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary keys-header-button" id="btn_add_keys"
                            onclick="app.addKeys();">
                        NEW KEYS
                    </button>
                    <button type="button" class="btn btn-primary keys-header-button" id="btn_reload_keys"
                            onclick="app.getServer();">
                        RELOAD KEYS
                    </button>
    ...
    <div class="sticky-pagination undisplayed" id="sticky_pagination_header">
    ...
    <div>
        <div class="tab-content">
            <div class="tab-pane text-center fade show active" id="pills_servers" role="tabpanel"
                 aria-labelledby="pills_servers_tab">
                <div class="col-12 col-lg-9 p-0 d-inline-block servers-wrapper">
                    <div class="row g-0">
                        <div class="col col-12 servers-empty" id="servers_empty">
                            <span>List is empty</span>
                        </div>
                        <div class="col-md-12 server-list" id="server_list">
                        </div>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade show" id="pills_keys" role="tabpanel" aria-labelledby="pills_keys_tab">
                <div class="w-100 p-0">
            ...
            <div class="tab-pane text-center fade show" id="pills_server" role="tabpanel"
                 aria-labelledby="pills_server_tab">
                <div class="col-12 col-lg-9 p-0 d-inline-block">
                    <div class="undisplayed" id="server_wrapper">
                        <div class="server-title">
                            <H5>CURRENT SERVER PROPERTIES</H5>
                        </div>
                        <div id="server_props">
                        </div>
                        <div class="server-buttons" id="server_buttons">
                            <button type="button" class="btn btn-primary btn-server" onclick="app.getServer()"
                                    title="Reload Server parameters">RELOAD SERVER PROPERTIES
                            </button>
                            <button type="button" class="btn btn-danger btn-server"
                                    onclick="app.removeKeysCustomLimits()"
                                    title="Remove All custom limits">REMOVE CUSTOM LIMITS
                            </button>
                            <button type="button" class="btn btn-danger btn-server" onclick="app.removeKeys()"
                                    title="Reload Server parameters">REMOVE ALL KEYS
                            </button>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal_limit_window" tabindex="-1">
    <div class="modal-dialog" id="modal_limit_dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer modal-footer-limit">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="modal_server_window" tabindex="-1">
    <div class="modal-dialog" id="modal_server_dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_server_header">EDIT SERVER</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="input-group">
                    <label for="modal_server_title" class="input-group-text input-group-label-server">TITLE</label>
                    <input class="form-control" id="modal_server_title"/>
                </div>
                <div class="input-group">
                    <label for="modal_server_url" class="input-group-text input-group-label-server">URL</label>
                    <input class="form-control " id="modal_server_url"/>
                </div>
            </div>
            <div class="modal-footer modal-footer-server">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button id="modal_server_save" type="button" class="btn btn-primary">SAVE</button>
            </div>
        </div>
    </div>
</div>
