...
export const ACTION_SERVER_GET_PROPERTIES = 'server_get_properties';
...
export const ACTION_KEY_LIST = 'key_list';
...
export const MESSAGE_KEY_LIST_FAILED = 'Key list obtain failed!';
...
export const MESSAGE_SERVER_GET_PROPERTIES_FAILED = 'Server get parameters failed!';
